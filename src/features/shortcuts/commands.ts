...
export const DEFAULT_COMMANDS = [
  ...
  command(
    "global.setup",
    "Go to Setup",
    "Navigate to accounts, categories, and subcategories setup.",
    "Global",
    "global",
    "Ctrl+Alt+S",
  ),
  ...
  command(
    ...
    "Navigate to settings and focus keyboard shortcuts.",
    "Global",
    "global",
    "Ctrl+Alt+K",
  ),
  ...
  command(
    "dashboard.applyDateRange",
    "Apply Date Range",
    "Apply the custom dashboard date range.",
    "Dashboard",
    "dashboard",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    "dashboard.focusStartDate",
    "Focus Start Date",
    "Focus the dashboard start date.",
    "Dashboard",
    "dashboard",
    "Alt+[",
  ),
  ...
  command(
    "transactionInput.addRow",
    "Add Transaction Row",
    "Add an empty transaction entry row.",
    "Add Transactions",
    "transactionInput",
    "Ctrl+Alt+N",
  ),
  command(
    ...
    "Clear all transaction entry rows.",
    "Add Transactions",
    "transactionInput",
    "Ctrl+Alt+Backspace",
  ),
  command(
    ...
    "Save all filled transaction entry rows.",
    "Add Transactions",
    "transactionInput",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    "transactionInput.focusStatementText",
    "Focus Statement Text",
    "Focus the statement text box.",
    "Add Transactions",
    "transactionInput",
    "Ctrl+Alt+T",
  ),
  command(
    "transactionInput.focusStatementAccount",
    "Focus Statement Account",
    "Focus the statement account selector.",
    "Add Transactions",
    "transactionInput",
    "Ctrl+Alt+U",
  ),
  command(
    "transactionInput.focusGrid",
    "Focus Transaction Grid",
    "Focus the first transaction entry cell.",
    "Add Transactions",
    "transactionInput",
    "Ctrl+Alt+F",
  ),
  command(
    "transactionInput.removeFocusedRow",
    "Remove Focused Row",
    "Remove the currently focused transaction entry row.",
    "Add Transactions",
    "transactionInputGrid",
    "Ctrl+Alt+Delete",
  ),
  command(
    "transactionInput.nextCell",
    "Next Transaction Cell",
    "Move to the next transaction entry cell.",
    "Add Transactions",
    "transactionInputGrid",
    "Ctrl+Alt+ArrowRight",
    { inputSafe: true },
  ...
  command(
    "transactionInput.previousCell",
    "Previous Transaction Cell",
    "Move to the previous transaction entry cell.",
    "Add Transactions",
    "transactionInputGrid",
    "Ctrl+Alt+ArrowLeft",
    { inputSafe: true },
  ...
  command(
    ...
    "Apply transaction history filters.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    ...
    "Focus the transaction history search field.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+F",
  ),
  command(
    "transactionHistory.focusStartDate",
    "Focus History Start Date",
    "Focus the transaction history start date.",
    "Transaction History",
    "transactionHistory",
    "Alt+[",
  ),
  command(
    "transactionHistory.focusEndDate",
    "Focus History End Date",
    "Focus the transaction history end date.",
    "Transaction History",
    "transactionHistory",
    "Alt+]",
  ),
  command(
    "transactionHistory.focusAccount",
    "Focus History Account Filter",
    "Focus the transaction history account filter.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+U",
  ),
  command(
    "transactionHistory.preset1",
    "History Preset 1",
    "Apply transaction history date preset 1.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+1",
  ),
  command(
    "transactionHistory.preset2",
    "History Preset 2",
    "Apply transaction history date preset 2.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+2",
  ),
  command(
    "transactionHistory.preset3",
    "History Preset 3",
    "Apply transaction history date preset 3.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+3",
  ),
  command(
    "transactionHistory.preset4",
    "History Preset 4",
    "Apply transaction history date preset 4.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+4",
  ),
  command(
    "transactionHistory.preset5",
    "History Preset 5",
    "Apply transaction history date preset 5.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+5",
  ),
  command(
    "transactionHistory.preset6",
    "History Preset 6",
    "Apply transaction history date preset 6.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+6",
  ),
  command(
    ...
    "Select or clear all visible transactions.",
    "Transaction History",
    "transactionHistoryTable",
    "Ctrl+Alt+X",
  ),
  command(
    "transactionHistory.toggleFocusedRow",
    "Toggle Focused Transaction",
    "Toggle selection for the focused transaction.",
    "Transaction History",
    "transactionHistoryTable",
    "Space",
  ),
  ...
  command(
    ...
    "Save the focused transaction edit.",
    "Transaction History",
    "transactionHistoryEdit",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    ...
    "Cancel the focused transaction edit.",
    "Transaction History",
    "transactionHistoryEdit",
    "Escape",
    { inputSafe: true },
  ...
  command(
    ...
    "Open delete confirmation for the focused transaction.",
    "Transaction History",
    "transactionHistoryTable",
    "Delete",
  ),
  command(
    ...
    "Open bulk edit for selected transactions.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+E",
  ),
  command(
    ...
    "Open bulk delete for selected transactions.",
    "Transaction History",
    "transactionHistory",
    "Ctrl+Alt+Backspace",
  ),
  ...
  command(
    ...
    "Sort transaction history by name.",
    "Transaction History",
    "transactionHistoryTable",
    "Alt+2",
  ),
  command(
    ...
    "Sort transaction history by amount.",
    "Transaction History",
    "transactionHistoryTable",
    "Alt+3",
  ),
  command(
    "transactionHistory.sortBalance",
    "Sort Transactions By Balance",
    "Sort transaction history by running balance.",
    "Transaction History",
    "transactionHistoryTable",
    "Alt+4",
  ),
  command(
    ...
    "Focus the next transaction row.",
    "Transaction History",
    "transactionHistoryTable",
    "ArrowDown",
  ),
  command(
    ...
    "Focus the previous transaction row.",
    "Transaction History",
    "transactionHistoryTable",
    "ArrowUp",
  ),
  ...
  command(
    ...
    "Focus the last transaction row.",
    "Transaction History",
    "transactionHistoryTable",
    "End",
  ),
  ...
  command(
    "setup.accounts.save",
    "Save Account Form",
    "Save the active account add or edit form.",
    "Setup",
    "setupAccounts",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    "setup.accounts.cancel",
    "Cancel Account Form",
    "Cancel account add or edit mode.",
    "Setup",
    "setupAccounts",
    "Escape",
    { inputSafe: true },
  ...
  command(
    "setup.accounts.editFocused",
    "Edit Focused Account",
    "Edit the focused account.",
    "Setup",
    "setupAccounts",
    "Enter",
  ),
  command(
    "setup.accounts.deleteFocused",
    "Delete Focused Account",
    "Open delete confirmation for the focused account.",
    "Setup",
    "setupAccounts",
    "Delete",
  ),
  command(
    ...
    "Open bulk delete for selected accounts.",
    "Setup",
    "setupAccounts",
    "Ctrl+Alt+Backspace",
  ),
  command(
    "setup.accounts.selectAll",
    "Select All Accounts",
    "Select or clear all visible accounts.",
    "Setup",
    "setupAccounts",
    "Ctrl+Alt+X",
  ),
  command(
    "setup.accounts.toggleFocused",
    "Toggle Focused Account",
    "Toggle focused account selection.",
    "Setup",
    "setupAccounts",
    "Space",
  ),
  ...
  command(
    "setup.categories.save",
    "Save Category Form",
    "Save the active category add or edit form.",
    "Setup",
    "setupCategories",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    ...
    "Cancel category add or edit mode.",
    "Setup",
    "setupCategories",
    "Escape",
    { inputSafe: true },
  ...
  command(
    "setup.categories.editFocused",
    "Edit Focused Category",
    "Edit the focused category.",
    "Setup",
    "setupCategories",
    "Enter",
  ),
  command(
    ...
    "Open delete confirmation for the focused category.",
    "Setup",
    "setupCategories",
    "Delete",
  ),
  command(
    ...
    "Open bulk delete for selected categories.",
    "Setup",
    "setupCategories",
    "Ctrl+Alt+Backspace",
  ),
  command(
    ...
    "Select or clear all visible categories.",
    "Setup",
    "setupCategories",
    "Ctrl+Alt+X",
  ),
  command(
    "setup.categories.toggleFocused",
    "Toggle Focused Category",
    "Toggle focused category selection.",
    "Setup",
    "setupCategories",
    "Space",
  ),
  ...
  command(
    ...
    "Save the active subcategory add or edit form.",
    "Setup",
    "setupSubcategories",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    "setup.subcategories.cancel",
    "Cancel Subcategory Form",
    "Cancel subcategory add or edit mode.",
    "Setup",
    "setupSubcategories",
    "Escape",
    { inputSafe: true },
  ...
  command(
    "setup.subcategories.editFocused",
    "Edit Focused Subcategory",
    "Edit the focused subcategory.",
    "Setup",
    "setupSubcategories",
    "Enter",
  ),
  command(
    "setup.subcategories.deleteFocused",
    "Delete Focused Subcategory",
    "Open delete confirmation for the focused subcategory.",
    "Setup",
    "setupSubcategories",
    "Delete",
  ),
  command(
    ...
    "Open bulk delete for selected subcategories.",
    "Setup",
    "setupSubcategories",
    "Ctrl+Alt+Backspace",
  ),
  command(
    ...
    "Select or clear all visible subcategories.",
    "Setup",
    "setupSubcategories",
    "Ctrl+Alt+X",
  ),
  command(
    "setup.subcategories.toggleFocused",
    "Toggle Focused Subcategory",
    "Toggle focused subcategory selection.",
    "Setup",
    "setupSubcategories",
    "Space",
  ),
  ...
  command(
    "setup.subcategories.sortCategory",
    "Sort Subcategories By Category",
    "Sort subcategories by category.",
    "Setup",
    "setupSubcategories",
    "Alt+2",
  ...
  command(
    "setup.subcategories.sortGoal",
    "Sort Subcategories By Goal",
    "Sort subcategories by monthly goal.",
    "Setup",
    "setupSubcategories",
    "Alt+3",
  ),
  ...
  command(
    "modal.confirm",
    "Confirm Modal",
    "Confirm the active modal action.",
    "Modals",
    "modal",
    "Ctrl+Enter",
    { inputSafe: true },
  ...
  command(
    "modal.cancel",
    "Cancel Modal",
    "Cancel or close the active modal.",
    "Modals",
    "modal",
    "Escape",
    { inputSafe: true },
  ...
  command(
    ...
    "Move focus to the keyboard shortcuts settings section.",
    "Settings",
    "settings",
    null,
  ),
  command(
    "settings.focusShortcutSearch",
    "Focus Shortcut Search",
    "Focus the shortcut command search field.",
    "Settings",
    "settings",
    "Ctrl+Alt+F",
  ),
  command(
    ...
    "Start editing the selected shortcut.",
    "Settings",
    "settingsShortcuts",
    "Enter",
  ),
  command(
    ...
    "Clear the selected shortcut binding.",
    "Settings",
    "settingsShortcuts",
    "Delete",
  ),
