...
export interface FlaggedWordsContextValue extends FlaggedWordsSettings {
  ...
  findTransactionMatches: (transactions: Array<{ name: string }>) => FlaggedWordMatch[];
}

export const FlaggedWordsContext = createContext<FlaggedWordsContextValue | null>(null);
