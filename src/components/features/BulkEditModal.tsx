...
export function BulkEditModal({
  ...
  const overlappingTagIds = addTagIds.filter((tagId) =>
  ...
  useShortcut("modal.confirm", handleConfirm, {
    enabled: isOpen && canConfirm,
  });
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground mb-3">
        Change type, subcategory, or tags for {selectedCount} transaction
        {selectedCount !== 1 ? "s" : ""}
      </p>
      <SimpleSelect
        value={kind}
