export const queryKeys = {
  ...
  dashboard: {
    ...
    categorySummary: (startDate: string, endDate: string, filters?: Record<string, unknown>) =>
      [...queryKeys.dashboard.all, 'category-summary', startDate, endDate, filters] as const,
    metrics: (startDate: string, endDate: string, filters?: Record<string, unknown>) =>
      [...queryKeys.dashboard.all, 'metrics', startDate, endDate, filters] as const,
    netWorthChart: (startDate: string, endDate: string) =>
      [...queryKeys.dashboard.all, 'charts', 'net-worth', startDate, endDate] as const,
    sankeyChart: (startDate: string, endDate: string, filters?: Record<string, unknown>) =>
      [...queryKeys.dashboard.all, 'charts', 'sankey', startDate, endDate, filters] as const,
