...
void test("account change scale treats liability decreases as positive", () => {
...
void test("category difference scale treats income shortfalls as negative", () => {
...
void test("transaction amount scale follows transaction kind", () => {
...
void test("scale value color class maps positive to green and negative to red", () => {
